...
<body>
    <div class="level">
        <div class="level-item">
            <p class="is-size-3 has-text-danger px-2 pt-2 ">Edit Category</p>
        </div>
    </div>
        ...
        <div class="level">
            <div class="level-item">
                <form action="/admin/editConfirm" method="post" class="form-group">
                    ...
                    <br>
                    <input type="text" class="form-control" value="{{$category->name}}" name="categoryName"> <br> <br>
                    <div class="level-item">
                    <button class="button mr-3" type="submit" name="edit_category" value="edit category" class="btn btn-primary">Confirm</button>
                    </div>
                </form>
            </div>
        </div>
